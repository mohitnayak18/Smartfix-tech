...
abstract class Dimens {
  ...
  static EdgeInsets edgeInsets0_94_0_0 = EdgeInsets.fromLTRB(
    zero,
    nintyFour,
    zero,
    zero,
  ...
  static EdgeInsets edgeInsets18_0_18_10 = EdgeInsets.fromLTRB(
    eighteen,
    zero,
    eighteen,
    ten,
  ...
  static EdgeInsets edgeInsets16_36_16_10 = EdgeInsets.fromLTRB(
    sixteen,
    thirtySix,
    sixteen,
    ten,
  ...
  static EdgeInsets edgeInsets16_16_16_10 = EdgeInsets.fromLTRB(
    sixteen,
    sixteen,
    sixteen,
    ten,
  ...
  static EdgeInsets edgeInsets10_16_10_0 = EdgeInsets.fromLTRB(
    ten,
    sixteen,
    ten,
    zero,
  ...
  static EdgeInsets edgeInsets16_20_30_20 = EdgeInsets.fromLTRB(
    sixteen,
    twenty,
    thirty,
    twenty,
  ...
  static EdgeInsets edgeInsets30_20_16_20 = EdgeInsets.fromLTRB(
    thirty,
    twenty,
    sixteen,
    twenty,
  ...
  static SizedBox boxWidth25 = SizedBox(height: twentyFive);
  ...
  static SizedBox boxHeight55 = SizedBox(height: fiftyFive);
